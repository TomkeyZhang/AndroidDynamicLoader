...
public class HomeActivity extends MyActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.go_anjuke).setOnClickListener(clickListener);
    }
    ...
    private final View.OnClickListener clickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (v.getId() == R.id.go) {
                ...
                findViewById(R.id.go).performClick();
            } else if (v.getId() == R.id.go_anjuke) {
                siteUrl.setText("https://raw.github.com/TomkeyZhang/AndroidDynamicLoader/master/site/anjuke/site.txt");
                findViewById(R.id.go).performClick();
            }
        }
    };
